...
/*                                                                          */
/*          Exemple 10 bis : gestion des Gestures de Ketai sur une image    */
/*                                                                          */
/* Exemple_10_bis_Android_Gestures.pde         Processing 3.5.4 - ANDROID   */
/****************************************************************************/
...
void onDoubleTap(float x, float y) {
 // On deplace l'image a cet endroit
 PositionX = x;
 PositionY = y;
}
