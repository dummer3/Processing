...
/*                                                                          */
/*          Exemple 10 : Dessin de deux cubes (simple et texture)           */
/*                       Reprise de l'exemple 7, avec adaptation Android    */
/*                                                                          */
/* Exemple_10_Android_CubeTexture.pde          Processing 3.5.4 - ANDROID   */
/****************************************************************************/
...
void setup() {
  ...
  fullScreen(P3D); // Ouverture en mode 3D
  
  // Pas de titre !!
  //surface.setTitle("Exemple 7 - Shape : Cubes avec et sans texture - E. Mesnard / ISIMA");
