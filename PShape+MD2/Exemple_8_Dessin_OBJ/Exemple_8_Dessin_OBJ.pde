...
/*                                                                          */
/*          Exemple 8 : Dessin d'un objet OBJ texture par P3D               */
/*                      avec calcul du recentrage de l'objet                */
/*                                                                          */
/* Exemple_8_Dessin_OBJ.pde                             Processing 3.5.4    */
/****************************************************************************/
...
void setup() {
  ...
  surface.setTitle("Exemple 8 - Dessin d'objets OBJ - E. Mesnard / ISIMA");
